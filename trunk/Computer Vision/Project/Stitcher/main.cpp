...
static void printUsage()
{
    cout <<
		...
		"stitcher --image_dir <image directory path> [flags]\n\n"
        "Flags:\n"
        "  --preview\n"
...
static int parseCmdArgs(int argc, char** argv)
{
    ...
    for (int i = 1; i < argc; ++i)
    {
        ...
        else if (string(argv[i]) == "--image_dir")
		{
			img_names = listdir(argv[i+1]);
			i++;
		}
    }
...
int stitching2()
{
	...
	printf("Warping images (auxiliary)... \n");
    t = getTickCount();
	...
	cout << "Save result to '" << result_name << "'" << endl;
...
int hough_transform(char *img)
{
	...
	HoughCircles( src_gray, circles, CV_HOUGH_GRADIENT, 2.5, src_gray.rows/8, 200, 100, 0, 0 );
...
int main( int argc, char* argv[] )
{
	...
	return stitching2();*/
	return hough_transform(argv[1]);//("D:\\Document\\Master\\Computer Vision\\Project\\Stitcher\\Debug\\InputData\\4\\02.jpg");
}
